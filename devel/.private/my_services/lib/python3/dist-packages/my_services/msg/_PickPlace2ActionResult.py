...
"""autogenerated by genpy from my_services/PickPlace2ActionResult.msg. Do not edit."""
import codecs
import sys
...
class PickPlace2ActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "my_services/PickPlace2ActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_services/PickPlace2Result']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PickPlace2ActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = my_services.msg.PickPlace2Result()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_services.msg.PickPlace2Result()
