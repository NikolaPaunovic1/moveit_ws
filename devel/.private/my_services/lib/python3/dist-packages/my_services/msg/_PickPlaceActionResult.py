...
"""autogenerated by genpy from my_services/PickPlaceActionResult.msg. Do not edit."""
import codecs
import sys
...
class PickPlaceActionResult(genpy.Message):
  ...
  _type = "my_services/PickPlaceActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_services/PickPlaceResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = my_services.msg.PickPlaceResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_services.msg.PickPlaceResult()
