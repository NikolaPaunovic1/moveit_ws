...
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ...
  primitive3.dimensions[primitive.BOX_X] = 0.02;
  primitive3.dimensions[primitive.BOX_Y] = 0.032;
  primitive3.dimensions[primitive.BOX_Z] = 0.064;
  ...
  target_pose2.position.z = 0.515+0.022;
